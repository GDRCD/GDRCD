    ...
    public function up()
    {
        ...
        DB::query("
            INSERT INTO `config` (`const_name`,`val`,`section`,`label`,`description`,`type`,`editable`) VALUES
                ...
                ('REGISTRAZIONI_ENABLED',1,'Registrazioni','Registrazioni attive','Registrazioni attive?','bool',1),
                ...
                ('GROUPS_STORAGE',1,'Gruppi','Magazzini gruppi attivi','Magazzini gruppi attivi','bool',1),
