...
class GDRCD57_Insert_ChatSave_In_Configurazioni_Table extends DbMigration
{
    public function up() {
        ...
        gdrcd_query("INSERT INTO `configurazioni` (`tipo`, `categoria`, `ordinamento`, `opzioni`, `default`, `parametro`, `valore`, `descrizione`, `input`) VALUES ('string', 'salva_chat', 1, 'si,no', 'no', 'solo_autore', 'no', 'Controlla che chi salva la chat abbia mandato un\'azione in chat', 'select')");
    ...
    public function down() {
        ...
        gdrcd_query("DELETE FROM `configurazioni` WHERE categoria = 'salva_chat' AND parametro = 'solo_autore'");
