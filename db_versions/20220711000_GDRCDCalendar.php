...
class GDRCDCalendar extends DbMigration
{
    ...
    public function up()
    {
        ...
        gdrcd_query("CREATE TABLE IF NOT EXISTS eventi_colori (
            id INT(11) NOT NULL AUTO_INCREMENT,
        ...
        gdrcd_query("CREATE TABLE IF NOT EXISTS eventi_tipo (
            id INT(11) NOT NULL AUTO_INCREMENT,
        ...
        gdrcd_query("INSERT INTO eventi_tipo (id, title, permessi) VALUES (1, 'QUEST', 'GAMEMASTER');
        ...
        gdrcd_query("INSERT INTO eventi_colori (id, backgroundColor, borderColor, textColor, colore) VALUES (1, 'purple', 'purple', 'white', 'Viola');
