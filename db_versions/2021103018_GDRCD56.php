...
ALTER spedito SET default CURRENT_TIMESTAMP");
...
ALTER COLUMN spedito SET DEFAULT CURRENT_TIMESTAMP");
...
ADD COLUMN oggetto text NULL DEFAULT NULL");
        ...
        gdrcd_query("ALTER TABLE messaggioaraldo
ALTER COLUMN data_messaggio SET DEFAULT CURRENT_TIMESTAMP");
    
        gdrcd_query("ALTER TABLE messaggioaraldo
ALTER COLUMN data_ultimo_messaggio SET DEFAULT CURRENT_TIMESTAMP");
    
        gdrcd_query("ALTER TABLE oggetto
ALTER COLUMN data_inserimento SET DEFAULT CURRENT_TIMESTAMP");
...
DROP COLUMN ultimo_messaggio");
    ...
    {
        gdrcd_query("ALTER TABLE backmessaggi
ALTER spedito SET default '0000-00-00 00:00:00'");
...
ALTER COLUMN data_evento SET DEFAULT '0000-00-00 00:00:00'");
        ...
        gdrcd_query("ALTER TABLE messaggi
ALTER COLUMN spedito SET DEFAULT '0000-00-00 00:00:00'");
...
DROP COLUMN oggetto");
        ...
        gdrcd_query("ALTER TABLE messaggioaraldo
ALTER COLUMN data_messaggio SET DEFAULT NULL");
    
        gdrcd_query("ALTER TABLE messaggioaraldo
ALTER COLUMN data_ultimo_messaggio SET DEFAULT NULL");
    
        gdrcd_query("ALTER TABLE oggetto
ALTER COLUMN data_inserimento SET DEFAULT '0000-00-00 00:00:00'");
    
        gdrcd_query("ALTER TABLE personaggio
CHANGE COLUMN ora_uscita ora_uscita datetime default NULL");
