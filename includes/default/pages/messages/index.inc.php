                ...
                <tr>
                    ...
                    <td>
                        <div class="elementi_elenco">
                            ...
                            } else if ( is_numeric($row['mittente']) == true ) {
                    ...
                    <td>
                        <div class="controlli_elenco">
                            <div class="controllo_elenco">
                                <!-- reply -->
                                <form
                                    action="main.php?page=messages_center<?php echo $isSentMessage ? '&op=inviati' : ''; ?>"
                                    method="post">
                                    <input type="hidden" name="reply_dest"
                                           value="<?php echo $isSentMessage ? $row['destinatario'] : $row['mittente']; ?>"/>
                                    <input type="hidden" name="reply_subject"
                                           value="Re: <?php echo $row['oggetto']; ?>"/>
