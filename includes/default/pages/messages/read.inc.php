...
if ( gdrcd_query($result, 'num_rows') == 0 ) { ?>
    ...
    <div class="read_message_box">
        <div class="infos">
            <span
                class="title"><?php echo gdrcd_filter('out', $MESSAGE['interface']['messages']['date']) . ": "; ?></span>
            <span class="body"><?php echo gdrcd_format_date($data_spedito) ?></span>
            <span
                class="title"><?php echo ' ' . gdrcd_filter('out', $MESSAGE['interface']['messages']['time']) . ' '; ?></span>
            <span class="body"><?php echo gdrcd_format_time($ora_spedito); ?>
 		    </span>
        </div>
        <div class="infos">
            <span
                class="title"><?php echo gdrcd_filter('out', $MESSAGE['interface']['messages']['sender']) . ": "; ?></span>
            <span class="body"><?php echo gdrcd_filter('out', $record['mittente']); ?></span>
        </div>
        <div class="infos">
            <span
                class="title"><?php echo gdrcd_filter('out', $MESSAGE['interface']['messages']['type']['title']) . ": "; ?></span>
            <span
                class="body"><?php echo gdrcd_filter('out', $MESSAGE['interface']['messages']['type']['options'][$record['tipo']]); ?></span>
        </div>
        <div class="infos">
            <span
                class="title"><?php echo gdrcd_filter('out', $MESSAGE['interface']['messages']['subject']) . ": "; ?></span>
        ...
        <div class="read_message_box_forms">
            <div class="read_message_box_form">
                <!-- attach -->
                <form action="main.php?page=messages_center&op=read&id_messaggio=<?php echo $record['id']; ?>"
                      method="post">
                    ...
                    <input type="image" src="imgs/icons/attach.png" value="submit"
            ...
            <div class="read_message_box_form">
                ...
                <form action="main.php?page=messages_center&op=read&id_messaggio=<?php echo $record['id']; ?>"
                    ...
                    <input type="image" src="imgs/icons/reply.png" value="submit"
