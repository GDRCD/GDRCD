    ...
    <form class="form_messaggi" action="main.php?page=messages_center" method="post">
        ...
        <div class='form_field'>
            <input type="text" list="personaggi" name="destinatario" placeholder="Nome del personaggio"
                   value="<?php echo gdrcd_filter('get', $_REQUEST['reply_dest']); ?>" required/>
        </div>
        <?php
        ...
        <!-- Tipo -->
        <div
            class='form_label'><?php echo gdrcd_filter('out', $MESSAGE['interface']['messages']['type']['title']); ?></div>
        <div class='form_field'>
        ...
        <div class='form_field'>
            ...
            <input type="text" name="oggetto" placeholder="Oggetto del messaggio"
                   value="<?php echo gdrcd_filter('out', trim($_REQUEST['reply_subject'])); ?>" required/>
        </div>
        <!-- Testo -->
        <div class='form_label'>
