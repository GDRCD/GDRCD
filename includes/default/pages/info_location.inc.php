    ...
    <div class="page_body">
        ...
        if ( $record_exists > 0 || $_SESSION['luogo'] == -1 ) {
            ...
            <div class="info_image">
                ...
                ?>
                <img
                    src="themes/<?php echo gdrcd_filter('out', $PARAMETERS['themes']['current_theme']); ?>/imgs/locations/<?php echo $immagine_luogo ?>"
            ...
            if ( $class->permissionEditChat() ) { ?>
                <p>
                    <a href="javascript:modalWindow('meteo', 'Modifica Meteo Chat', 'popup.php?page=meteo_chat&dir=<?= $_REQUEST['dir'] ?>')">Modifica
                        Meteo</a></p>
                <?php
            }
