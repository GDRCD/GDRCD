...
$CREDITS =  gdrcd_filter('out', 'Basato su "GDRCD '.$GLOBALS['PARAMETERS']['info']['GDRCD'].'". CMS Open Source sviluppato dal ').
            '<a href="https://github.com/orgs/GDRCD/people" target="_blank">'.gdrcd_filter('out', 'Team di GDRCD').'</a>'.
            gdrcd_filter('out',' e distribuito gratuitamente.');
