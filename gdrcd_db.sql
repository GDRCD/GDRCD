...
INSERT INTO `config` (`const_name`,`val`,`section`,`label`,`description`,`type`,`editable`) VALUES
    ...
    ('CHAT_EXP',1,'Chat','Exp in chat','Esperienza in chat, attiva?','bool',1),
    ('CHAT_PVT_EXP',0,'Chat','Exp in chat pvt','Esperienza in chat pvt, attiva?','bool',1),
    ('CHAT_EXP_MASTER',1,'Chat','Exp master','Esperienza per ogni azione master','int',1),
    ('CHAT_EXP_AZIONE',1,'Chat','Exp azione','Esperienza per ogni azione normale','int',1),
    ('CHAT_EXP_MIN',500,'Chat','Minimo caratteri','Minimo di caratteri per esperienza','int',1),
    ...
    ('CHAT_DICE',1,'Chat','Dadi in chat','Dadi attivi in chat?','bool',1),
    ('CHAT_DICE_BASE',20,'Chat','Tipo dado in chat','Numero massimo dado in chat','int',1),
    ('CHAT_SKILL_BUYED',0,'Chat','Solo abilità acquistate','Solo skill acquistate nel lancio in chat','bool',1),
    ('CHAT_EQUIP_BONUS',0,'Chat','Bonus equipaggimento','Bonus equipaggiamento ai dadi in chat?','bool',1),
    ('CHAT_EQUIP_EQUIPPED',1,'Chat','Solo equipaggiamento','Solo oggetti equipaggiati in chat?','bool',1),
    ('CHAT_SAVE',1,'Chat','Salva chat','Salva chat attivo?','bool',1),
    ('CHAT_PVT_SAVE',1,'Chat','Salva chat pvt','Salva chat attivo in pvt?','bool',1),
    ('CHAT_SAVE_LINK',1,'Chat','Salva chat in link','Salva chat in modalità link?','bool',1),
    ('CHAT_SAVE_DOWNLOAD',1,'Chat','Salva chat download','Salva chat con download?','bool',1);
