...
$PARAMETERS['administration']['meteo_season']['text'] = 'Gestione delle Stagioni';
$PARAMETERS['administration']['meteo_season']['url'] = 'main.php?page=gestione_meteo_stagioni';
$PARAMETERS['administration']['meteo_season']['access_level'] = SUPERUSER;
