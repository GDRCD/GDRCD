...
<div class="stats">
	...
	<table class="statistics">
		<tbody>
		<tr>
			<td><?php echo gdrcd_filter('out', $MESSAGE['interface']['user']['stats']['creation_date']); ?>:
			</td>
		...
		<tr>
			<td><?php echo gdrcd_filter('out', $MESSAGE['interface']['user']['stats']['topics']); ?>:</td>
			<td><?php echo $weekly_posts['num']; ?></td>
		</tr>
		<tr>
			<td><?php echo gdrcd_filter('out', $MESSAGE['interface']['user']['stats']['last_chat']); ?>:</td>
			<td><?php echo $weekly_actions    ['num']; ?></td>
		</tr>
		<tr>
			<td><?php echo gdrcd_filter('out', $MESSAGE['interface']['user']['stats']['last_characters']); ?>
				:
			</td>
