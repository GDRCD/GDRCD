<div class="panels_box">
    <form class="form_messaggi" action="main.php?page=messages_center" method="post">
        ...
        <div class='form_field'>
            <input type="text" list="personaggi" name="destinatario" placeholder="Nome del personaggio" value="<?php echo gdrcd_filter('get', $_REQUEST['reply_dest']); ?>" required/>
        </div>
        <?php
        ...
        <div class='form_field'>
            <select name="tipo" required>
                ...
                foreach($MESSAGE['interface']['messages']['type']['options'] AS $tipoID => $tipoNome) {
                    ...
                    $isSelected = ($_REQUEST['reply_tipo'] == $tipoID ? 'selected' : NULL);
        ...
        <div class='form_field'>
            ...
            <input type="text" name="oggetto" placeholder="Oggetto del messaggio" value="<?php echo gdrcd_filter('out', trim($_REQUEST['reply_subject'])); ?>" required/>
        </div>
        <!-- Testo -->
        <div class='form_label'>
