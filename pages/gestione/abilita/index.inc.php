...
$record_globale = gdrcd_stmt_one("SELECT COUNT(*) FROM abilita");
$totaleresults = $record_globale['COUNT(*)'];

//Lettura record
$result = gdrcd_stmt_all("SELECT id_abilita, nome, car FROM abilita ORDER BY nome LIMIT ".$pagebegin.", ".$pageend."" );
                        ...
                        <div class="controlli_elenco">
                            <div class="controllo_elenco">
                                <form class="opzioni_elenco_record_gestione" action="main.php?page=gestione_abilita" method="post">
                                    ...
                                    <input type="image" alt="<?php echo gdrcd_filter('out', $MESSAGE['interface']['administration']['ops']['edit']); ?>" title="<?php echo gdrcd_filter('out', $MESSAGE['interface']['administration']['ops']['edit']); ?>" src="public/images/icons/edit.png" />
                                </form>
                            </div>
                            <!-- Elimina -->
                            <div class="controllo_elenco">
