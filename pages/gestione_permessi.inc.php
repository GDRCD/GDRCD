    ...
    { ?>
        ...
        <div class="page_body">
            ...
            )
            {
                ...
                gdrcd_query("UPDATE personaggio SET permessi = " . gdrcd_filter('num',
                        $_POST['permessi']) . " WHERE nome = '" . gdrcd_filter('in', $_POST['nome']) . "' LIMIT 1");
                ...
                gdrcd_query("INSERT INTO log (nome_interessato, autore, data_evento, codice_evento, descrizione_evento) VALUES ('" . gdrcd_filter('in',
                        $_POST['nome']) . "','" . $_SESSION['login'] . "', NOW(), '" . CHANGEDROLE . "', '->" . $newrole . "')");
                ...
                gdrcd_query("INSERT INTO messaggi (mittente, destinatario, spedito, testo) VALUES ('" . $_SESSION['login'] . "', '" . gdrcd_filter('in',
                        ...
                        $MESSAGE['interface']['administration']['roles']['message_body'][0] . $newrole . $MESSAGE['interface']['administration']['roles']['message_body'][1]) . "')");
                ...
                <div class="link_back">
                    <a href="main.php?page=gestione_permessi">
                        <?php echo gdrcd_filter('out',
                            $MESSAGE['interface']['administration']['roles']['link']['back']); ?>
                    </a>
                </div>
            <?php } ?>
            ...
            {
                $result = gdrcd_query("SELECT nome, permessi FROM personaggio WHERE permessi > " . USER . " ORDER BY permessi DESC",
                    'result'); ?>
                            ...
                            <div class='form_field'>
                                ...
                                <select name="permessi" ?>
                                    ...
                                    <option value="<?php echo GUILDMODERATOR; ?>"
                                        <?php if ($row['permessi'] == GUILDMODERATOR)
                                        {
                                            echo 'SELECTED';
                                        } ?> />
                                    ...
                                    <option value="<?php echo GAMEMASTER; ?>"
                                        <?php if ($row['permessi'] == GAMEMASTER)
                                        {
                                            echo 'SELECTED';
                                        } ?> />
                            ...
                            <div class='form_submit'>
                                ...
                                <input type="submit"
                                       value="<?php echo gdrcd_filter('out',
                                           $MESSAGE['interface']['administration']['roles']['submit']['edit']); ?>"
                                       name="op"/>
                            </div>
				...
				<?php } ?>
                        ...
                        <div class='form_submit'>
                            <input type="submit"
                                   value="<?php echo gdrcd_filter('out',
                                       $MESSAGE['interface']['administration']['roles']['submit']['new']); ?>"
                                   name="op"/>
                        </div>
                    </form>
                </div>
