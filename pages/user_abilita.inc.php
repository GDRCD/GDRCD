                    ...
                    <tr>
                        <td class="casella_titolo">
                            <div class="titoli_elenco"><?php echo gdrcd_filter('out',
                                    $MESSAGE['interface']['skills']['skill']); ?></div>
                        </td>
                        <td class="casella_titolo">
                            <div class="titoli_elenco"><?php echo gdrcd_filter('out',
                                    $MESSAGE['interface']['skills']['car']); ?></div>
                        </td>
                        <td class="casella_titolo">
                            <div class="titoli_elenco"><?php echo gdrcd_filter('out',
                                    $MESSAGE['interface']['skills']['desc']); ?></div>
                        </td>
                    </tr>
                        ...
                        <tr>
                            ...
                            <td class="casella_elemento">
                                <div class="elementi_elenco"><?php echo gdrcd_filter('out',
                                        $PARAMETERS['names']['stats']['car' . $row['car']]); ?></div>
                            </td>
                            <td class="casella_elemento">
                    ...
                    <tr>
                        <td colspan="3">
                            <div class="page_title"><h2><?php echo gdrcd_filter('out',
                                        $MESSAGE['interface']['skills']['sys_tit']); ?></h2></div>
                            <div style='text-align: justify'><?php echo gdrcd_filter('out',
                                    $MESSAGE['interface']['skills']['sys']); ?></div>
                        </td>
                    </tr>
                </table>
            </div>
