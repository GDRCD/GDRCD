<div class="pagina_scheda_equip">
    ...
    if ((gdrcd_filter('get',
                $_POST['op']) == "in_zaino") && (($_SESSION['login'] == $_REQUEST['pg']) || ($_SESSION['permessi'] >= GAMEMASTER))
    )
    {
        gdrcd_query("UPDATE clgpersonaggiooggetto SET posizione = 1 WHERE id_oggetto = " . gdrcd_filter('num',
    ...
    if ((gdrcd_filter('get',
                $_POST['op']) == "indossa") && (($_SESSION['login'] == $_REQUEST['pg']) || ($_SESSION['permessi'] >= GAMEMASTER))
    )
    {
        gdrcd_query("UPDATE clgpersonaggiooggetto SET posizione = " . gdrcd_filter('num',
                $_POST['posizione']) . " WHERE id_oggetto = " . $_POST['id_oggetto'] . " AND nome = '" . gdrcd_filter('get',
                $_REQUEST['pg']) . "' LIMIT 1 ");
    ...
    if ((gdrcd_filter('get',
                $_POST['op']) == "abbandona") && (($_SESSION['login'] == $_REQUEST['pg']) || ($_SESSION['permessi'] >= GAMEMASTER))
    )
    { /*Rimuovo un oggetto*/
        ...
        gdrcd_query("INSERT INTO log (nome_interessato, autore, data_evento, codice_evento ,descrizione_evento) VALUES ('" . gdrcd_filter('in',
                $_REQUEST['pg']) . "', '" . $_SESSION['login'] . "', NOW(), " . BONIFICO . ", ' -" . gdrcd_filter('in',
                $_POST['checosa']) . "')");
        echo '<div class="warning">' . gdrcd_filter('out', $MESSAGE['warning']['done']) . '</div>';
    ...
    if ((gdrcd_filter('get',
                $_POST['op']) == "cedi") && (($_SESSION['login'] == $_REQUEST['pg']) || ($_SESSION['permessi'] >= GAMEMASTER))
    )
    { /*Rimuovo un oggetto*/
        /*Se ne possiedo più di uno ne rimuovo uno solo*/

        $result_min = gdrcd_query("SELECT id_oggetto FROM clgpersonaggiooggetto WHERE id_oggetto = " . gdrcd_filter('num',
        ...
        if (gdrcd_query($result_min, 'num_rows') > 0)
        {
            ...
            $result_loc = gdrcd_query("SELECT id_oggetto FROM clgpersonaggiooggetto WHERE id_oggetto = " . gdrcd_filter('num',
                    $_POST['id_oggetto']) . " AND nome = '" . gdrcd_filter('in', $_POST['give_item']) . "'", 'result');
            ...
            } else
            {
                $query = "INSERT INTO clgpersonaggiooggetto (nome, id_oggetto, cariche, numero) VALUES ('" . gdrcd_filter('in',
                        ...
                        $_POST['id_oggetto']) . ", " . gdrcd_filter('num', $_POST['cariche']) . ", 1)";
            }
            gdrcd_query($query);
            /*Registro l'evento*/
            gdrcd_query("INSERT INTO log (nome_interessato, autore, data_evento, codice_evento ,descrizione_evento) VALUES ('" . $_POST['give_item'] . "', '" . $_SESSION['login'] . "', NOW(), " . BONIFICO . ", '" . gdrcd_filter('in',
                    $_POST['checosa']) . "')");
    ...
    $result = gdrcd_query("SELECT oggetto.id_oggetto, oggetto.nome, oggetto.urlimg AS immagine, clgpersonaggiooggetto.posizione FROM clgpersonaggiooggetto JOIN oggetto ON clgpersonaggiooggetto.id_oggetto = oggetto.id_oggetto WHERE clgpersonaggiooggetto.posizione > 1 AND clgpersonaggiooggetto.nome='" . gdrcd_filter('get',
            $_REQUEST['pg']) . "'", 'result');
            ...
            <tr>
                <td>
                    ...
                    <div class="omino_bianco_head">
                        ...
                        { ?>
                            <img
                                src="themes/<?php echo $PARAMETERS['themes']['current_theme']; ?>/imgs/items/<?php echo $oggetti[7]['immagine']; ?>"
                    ...
                    <div class="omino_bianco_neck">
                        ...
                        { ?>
                            <img
                                src="themes/<?php echo $PARAMETERS['themes']['current_theme']; ?>/imgs/items/<?php echo $oggetti[9]['immagine']; ?>"
                    ...
                    <div class="omino_bianco_armdx">
                        ...
                        { ?>
                            <img
                                src="themes/<?php echo $PARAMETERS['themes']['current_theme']; ?>/imgs/items/<?php echo $oggetti[2]['immagine']; ?>"
                    ...
                    <div class="omino_bianco_ring">
                        ...
                        { ?>
                            <img
                                src="themes/<?php echo $PARAMETERS['themes']['current_theme']; ?>/imgs/items/<?php echo $oggetti[8]['immagine']; ?>"
                    ...
                    <div class="omino_bianco_feet">
                        ...
                        { ?>
                            <img
                                src="themes/<?php echo $PARAMETERS['themes']['current_theme']; ?>/imgs/items/<?php echo $oggetti[6]['immagine']; ?>"
                ...
                <td>
                    ...
                    <div class="omino_bianco_chest">
                        ...
                        { ?>
                            <img
                                src="themes/<?php echo $PARAMETERS['themes']['current_theme']; ?>/imgs/items/<?php echo $oggetti[4]['immagine']; ?>"
                    ...
                    <div class="omino_bianco_armsx">
                        ...
                        { ?>
                            <img
                                src="themes/<?php echo $PARAMETERS['themes']['current_theme']; ?>/imgs/items/<?php echo $oggetti[3]['immagine']; ?>"
                    ...
                    <div class="omino_bianco_legs">
                        ...
                        { ?>
                            <img
                                src="themes/<?php echo $PARAMETERS['themes']['current_theme']; ?>/imgs/items/<?php echo $oggetti[5]['immagine']; ?>"
                    ...
                    { ?>
                        ...
                        <tr>
                            ...
                            <td class="casella_elemento">
                                ...
                                <div class="inventario_quantita">
                                    <?php echo gdrcd_filter('out',
                                        $MESSAGE['interface']['sheet']['items']['list']['pts'] . ": " . $record['numero']); ?>
                                ...
                                { ?>
                                    <div class="form_gioco">
                                        ...
                                        <form action="main.php?page=scheda_oggetti"
                                            ...
                                            <input type="submit"
                                                   value="<?php echo gdrcd_filter('out',
                                                       $MESSAGE['interface']['sheet']['items']['list']['put_away']); ?>"/>
                                        </form>
                                        ...
                                        <?php if ($record['ubicabile'] > ZAINO)
                                        {
                                            ...
                                            if ($record['posizione'] == 1)
                                            {
                                                ...
                                                { ?>
                                                    ...
                                                    <form action="main.php?page=scheda_equip"
                                                        ...
                                                        <input type="submit"
                                                               value="<?php echo gdrcd_filter('out',
                                                                   $MESSAGE['interface']['sheet']['items']['list']['wear']); ?>"/>
                                                    </form>
                                                <?php } //if
                                                ...
                                                { ?>
                                                    ...
                                                    <form action="main.php?page=scheda_equip"
                                                        ...
                                                        <input type="submit"
                                                               value="<?php echo gdrcd_filter('out',
                                                                   $MESSAGE['interface']['sheet']['items']['list']['wield'] . ' (DX)'); ?>"/>
                                                    </form>
                                                <?php } //if
                                                ...
                                                { ?>
                                                    ...
                                                    <form action="main.php?page=scheda_equip"
                                                        ...
                                                        <input type="submit"
                                                               value="<?php echo gdrcd_filter('out',
                                                                   $MESSAGE['interface']['sheet']['items']['list']['wield'] . ' (SX)'); ?>"/>
                                                    </form>
                                                <?php } //if
                                            ...
                                            { ?>
                                                ...
                                                <form action="main.php?page=scheda_equip"
                                                    ...
                                                    <input type="submit"
                                                           value="<?php echo gdrcd_filter('out',
                                                               $MESSAGE['interface']['sheet']['items']['list']['unwear']); ?>"/>
                                                </form>
                                        ...
                                        { ?>
                                            <form action="main.php?page=scheda_equip"
                                                ...
                                                <input type="submit"
                                                       value="<?php echo gdrcd_filter('out',
                                                           $MESSAGE['interface']['sheet']['items']['list']['give']); ?>"/>
        ...
        <div class="link_back">
            <a href="main.php?page=scheda_oggetti&pg=<?php echo gdrcd_filter('url',
                $_REQUEST['pg']); ?>"><?php echo gdrcd_filter('out',
                        $MESSAGE['interface']['sheet']['menu']['inventory']) . '.'; ?></a><br/>
