<div class="gestione_bacheche">
    ...
    { ?>
        ...
        <div class="page_body">
            ...
            if (gdrcd_filter('get',
                    $_POST['op']) == $MESSAGE['interface']['administration']['forums']['submit']['insert']
            )
            { ?>
                <?php /*Eseguo l'inserimento*/
                gdrcd_query("INSERT INTO araldo (nome, tipo, proprietari) VALUES ('" . gdrcd_filter('in',
                        $_POST['nome']) . "', " . gdrcd_filter('num', $_POST['tipo']) . ", " . gdrcd_filter('num',
                        $_POST['owner']) . ")"); ?>
                <div class="warning">
                ...
                <div class="link_back">
                    <a href="main.php?page=gestione_bacheche">
                        <?php echo gdrcd_filter('out',
                            $MESSAGE['interface']['administration']['forums']['link']['back']); ?>
                    </a>
                </div>
            <?php } ?>
            ...
            { ?>
                ...
                gdrcd_query("DELETE FROM messaggioaraldo WHERE id_araldo=" . gdrcd_filter('num',
                        $_POST['id_record']) . "");

                gdrcd_query("DELETE FROM araldo WHERE id_araldo=" . gdrcd_filter('num',
            ...
            { ?>
                ...
                gdrcd_query("UPDATE araldo SET nome ='" . gdrcd_filter('in',
                        $_POST['nome']) . "', tipo = " . gdrcd_filter('num',
                        $_POST['tipo']) . ", proprietari = " . gdrcd_filter('num',
                        $_POST['owner']) . " WHERE id_araldo = " . gdrcd_filter('num',
                        $_POST['id_record']) . " LIMIT 1");
            ...
            if ((gdrcd_filter('get', $_POST['op']) == 'edit') || (gdrcd_filter('get', $_REQUEST['op']) == 'new'))
            {
                ...
                if (gdrcd_filter('get', $_POST['op']) == 'edit')
                {
                    ...
                    */
                    $loaded_record = gdrcd_query("SELECT * FROM araldo WHERE id_araldo=" . gdrcd_filter('num',
                            $_POST['id_record']) . " LIMIT 1 ");
                ...
                <div class="panels_box">
                    <form action="main.php?page=gestione_bacheche"
                        ...
                        <div class='form_label'>
                            <?php echo gdrcd_filter('out',
                                $MESSAGE['interface']['administration']['forums']['name']); ?>
                        </div>
                        ...
                        <div class='form_label'>
                            <?php echo gdrcd_filter('out',
                                $MESSAGE['interface']['administration']['forums']['type']['name']); ?>
                        </div>
                        <div class='form_field'>
                            <!-- Elenco dei tipi -->
                            <select name="tipo">
                                <option value="<?php echo INGIOCO; ?>"
                                    <?php if ($loaded_record['tipo'] == INGIOCO)
                                    {
                                        echo "selected";
                                    } ?>>
                                ...
                                <option value="<?php echo PERTUTTI; ?>"
                                    <?php if ($loaded_record['tipo'] == PERTUTTI)
                                    {
                                        echo "selected";
                                    } ?>>
                                    <?php echo gdrcd_filter('out',
                                        $MESSAGE['interface']['forums']['type'][PERTUTTI]); ?>
                                </option>
                                <option value="<?php echo SOLORAZZA; ?>"
                                    <?php if ($loaded_record['tipo'] == SOLORAZZA)
                                    {
                                        echo "selected";
                                    } ?>>
                                    <?php echo gdrcd_filter('out',
                                        $MESSAGE['interface']['forums']['type'][SOLORAZZA]); ?>
                                </option>
                                <option value="<?php echo SOLOGILDA; ?>"
                                    <?php if ($loaded_record['tipo'] == SOLOGILDA)
                                    {
                                        echo "selected";
                                    } ?>>
                                    <?php echo gdrcd_filter('out',
                                        $MESSAGE['interface']['forums']['type'][SOLOGILDA]); ?>
                                </option>
                                <option value="<?php echo SOLOMASTERS; ?>"
                                    <?php if ($loaded_record['tipo'] == SOLOMASTERS)
                                    {
                                        echo "selected";
                                    } ?>>
                                    <?php echo gdrcd_filter('out',
                                ...
                                <option value="<?php echo SOLOMODERATORS; ?>"
                                    <?php if ($loaded_record['tipo'] == SOLOMODERATORS)
                                    {
                                        echo "selected";
                                    } ?>>
                                    <?php echo gdrcd_filter('out',
                                        $MESSAGE['interface']['forums']['type'][SOLOMODERATORS]); ?>
                                </option>
                            </select>
                        </div>
                        <div class='form_info'>
                        ...
                        <div class='form_label'>
                            <?php echo gdrcd_filter('out',
                                $MESSAGE['interface']['administration']['forums']['owner']); ?>
                        </div>
                        <div class='form_field'>
                            ...
                            <select name="owner">
                                ...
                                <option value="-1"><!-- Opzione "Nessuno" -->
                                    <?php echo gdrcd_filter('out',
                                        $MESSAGE['interface']['administration']['forums']['no_owner']); ?>
                                </option>
                        ...
                        <div class='form_submit'>
                            ...
                            if ($operation == "edit")
                            {
                                ...
                                <input type="hidden" name="id_record"
                                       value="<?php echo $loaded_record['id_araldo']; ?>">
                                <input type="submit"
                                       value="<?php echo gdrcd_filter('out',
                                           $MESSAGE['interface']['administration']['forums']['submit']['edit']); ?>"
                                       name="op"/>
                                <input type="submit"
                                       value="<?php echo gdrcd_filter('out',
                                           $MESSAGE['interface']['administration']['forums']['submit']['undo']); ?>"
                                       name="cancel"/>
                            ...
                            { ?>
                                <input type="submit"
                                       value="<?php echo gdrcd_filter('out',
                                           $MESSAGE['interface']['administration']['forums']['submit']['insert']); ?>"
                                       name="op"/>
                            <?php } ?>
                ...
                <!-- Link di ritorno alla visualizzazione di base -->
                <div class="link_back">
                    <a href="main.php?page=gestione_bacheche"><?php echo gdrcd_filter('out',
                            $MESSAGE['interface']['administration']['forums']['link']['back']); ?></a>
                </div>
            <?php }//if
            ?>
            ...
            <?php if ((isset($_POST['op']) === false) && (isset($_REQUEST['op']) === false))
            {
                ...
                */
                ...
                //Lettura record
                $result = gdrcd_query("SELECT id_araldo, nome, tipo FROM araldo ORDER BY nome LIMIT " . $pagebegin . ", " . $pageend . "",
                    'result');
                            ...
                            <tr>
                                <td class="casella_titolo">
                                    <div class="titoli_elenco"><?php echo gdrcd_filter('out',
                                            $MESSAGE['interface']['administration']['forums']['name']); ?></div>
                                </td>
                                <td class="casella_titolo">
                                    <div class="titoli_elenco"><?php echo gdrcd_filter('out',
                                            $MESSAGE['interface']['administration']['forums']['type']['name']); ?></div>
                                </td>
                                <td class="casella_titolo">
                                    <div class="titoli_elenco"><?php echo gdrcd_filter('out',
                            ...
                            { ?>
                                <tr>
                                    ...
                                    <td class="casella_elemento">
                                        <div class="elementi_elenco">
                                            <?php echo gdrcd_filter('out',
                                                $MESSAGE['interface']['forums']['type'][$row['tipo']]); ?>
                                        </div>
                                    </td>
                                    <!-- Icone dei controlli -->
                ...
                <div class="link_back">
                    <a href="main.php?page=gestione_bacheche&op=new">
                        <?php echo gdrcd_filter('out',
                            $MESSAGE['interface']['administration']['forums']['link']['new']); ?>
                    </a>
                </div>
