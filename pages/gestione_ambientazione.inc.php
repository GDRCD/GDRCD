    ...
    { ?>
        ...
        <div class="page_body">
            ...
            if ($_POST['op'] == 'insert')
            {
                ...
                gdrcd_query("INSERT INTO ambientazione (capitolo, titolo, testo) VALUES (" . gdrcd_filter('num',
                        $_POST['articolo']) . ", '" . gdrcd_filter('in', $_POST['titolo']) . "', '" . gdrcd_filter('in',
                        $_POST['testo']) . "')");
                ?>
                <div class="warning">
                ...
                <div class="link_back">
                    <a href="main.php?page=gestione_ambientazione">
                        <?php echo gdrcd_filter('out',
                            $MESSAGE['interface']['administration']['plot']['link']['back']); ?>
                    </a>
                </div>
            <?php } ?>
            ...
            if ($_POST['op'] == 'erase')
            {
                ...
                gdrcd_query("DELETE FROM ambientazione WHERE capitolo=" . gdrcd_filter('num',
            ...
            if (gdrcd_filter('get', $_POST['op']) == 'doedit')
            {
                ...
                gdrcd_query("UPDATE ambientazione SET titolo ='" . gdrcd_filter('in',
                        $_POST['titolo']) . "', testo ='" . gdrcd_filter('in',
                        $_POST['testo']) . "', capitolo = " . gdrcd_filter('in',
                        $_POST['articolo']) . " WHERE capitolo = " . gdrcd_filter('num', $_POST['art']) . " LIMIT 1");
                ?>
                <div class="warning">
            ...
            )
            {
                ...
                if ($_POST['op'] == 'edit')
                {
                    ...
                    */
                    $loaded_record = gdrcd_query("SELECT * FROM ambientazione WHERE capitolo=" . gdrcd_filter('num',
                            $_POST['id_record']) . " LIMIT 1 ");
                ...
                <div class="panels_box">
                    <form action="main.php?page=gestione_ambientazione"
                          method="post"
                          class="form_gestione">
                        ...
                        <div class='form_field'>
                            <input name="articolo"
                                   value="<?php echo 0 + $loaded_record['capitolo']; ?>"/>
                        </div>
                        ...
                        <div class='form_field'>
                            <textarea name="testo"><?php echo gdrcd_filter('out',
                                    $loaded_record['testo']); ?></textarea>
                        </div>
                        <div class="form_info">
                            ...
                            if ($operation == "edit")
                            {
                                ...
                                <input type="submit"
                                       value="<?php echo gdrcd_filter('out',
                                           $MESSAGE['interface']['forms']['modify']); ?>"/>
                                <input type="hidden"
                                       name="art"
                                       value="<?php echo 0 + $loaded_record['capitolo']; ?>">
                                <input type="hidden"
            ...
            { /*Elenco record (Visualizzaione di base della pagina)*/
                ...
                //Lettura record
                $result = gdrcd_query("SELECT capitolo, titolo, testo FROM ambientazione ORDER BY capitolo LIMIT " . $pagebegin . ", " . $pageend . "",
                    'result');
                            ...
                            <tr>
                                <td class="casella_titolo">
                                    <div class="titoli_elenco"><?php echo gdrcd_filter('out',
                                            $MESSAGE['interface']['administration']['plot']['art']); ?></div>
                                </td>
                                <td class="casella_titolo">
                                    <div class="titoli_elenco"><?php echo gdrcd_filter('out',
                                            $MESSAGE['interface']['administration']['plot']['titolo']); ?></div>
                                </td>
                                <td class="casella_titolo">
                                    <div class="titoli_elenco"><?php echo gdrcd_filter('out',
                                        ...
                                        <div class="controlli_elenco">
                                            <div class="controllo_elenco">
                                                <form class="opzioni_elenco_record_gestione"
                                                      action="main.php?page=gestione_ambientazione" method="post">
                                                    <input type="hidden" name="id_record"
                                                           value="<?php echo $row['capitolo'] ?>"/>
                ...
                <div class="link_back">
                    <a href="main.php?page=gestione_ambientazione&op=new">
                        <?php echo gdrcd_filter('out',
                            $MESSAGE['interface']['administration']['plot']['link']['new']); ?>
                    </a>
                </div>
