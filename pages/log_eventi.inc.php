...
<?php //*Elenco log*/
	...
	//Lettura record
	$result=gdrcd_query("SELECT autore, nome_interessato, data_evento, descrizione_evento FROM log WHERE codice_evento =".$_REQUEST['which_log']." ORDER BY data_evento DESC LIMIT ".$pagebegin.", ".$pageend."", 'result'); 
