<?php
$blocco = gdrcd_query("SELECT id, id_personaggio_destinatario, titolo FROM blocco_esiti WHERE id_personaggio_destinatario = '".gdrcd_filter('in',$_SESSION['id_personaggio'])."'
