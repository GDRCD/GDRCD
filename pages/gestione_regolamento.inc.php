    ...
    { ?>
        ...
        <div class="page_body">
            ...
            if ($_POST['op'] == 'insert')
            {
                ...
                {
                    gdrcd_query("INSERT INTO regolamento (articolo, titolo, testo) VALUES (" . gdrcd_filter('num',
                            $_POST['articolo']) . ", '" . gdrcd_filter('in',
                            $_POST['titolo']) . "', '" . gdrcd_filter('in', $_POST['testo']) . "')");
                ...
                <div class="link_back">
                    <a href="main.php?page=gestione_regolamento">
                        <?php echo gdrcd_filter('out',
                            $MESSAGE['interface']['administration']['rules']['link']['back']); ?>
                    </a>
                </div>
            <?php } ?>
            ...
            if ($_POST['op'] == 'erase')
            {
                ...
                gdrcd_query("DELETE FROM regolamento WHERE articolo=" . gdrcd_filter('num',
            ...
            if ($_POST['op'] == 'doedit')
            {
                ...
                if ((is_numeric($_POST['art']) == true) && (is_numeric($_POST['articolo']) == true))
                {
                    ...
                    gdrcd_query("UPDATE regolamento SET titolo ='" . gdrcd_filter('in',
                            $_POST['titolo']) . "', testo ='" . gdrcd_filter('in',
                            $_POST['testo']) . "', articolo = " . gdrcd_filter('num',
                            $_POST['articolo']) . " WHERE articolo = " . gdrcd_filter('num',
                            $_POST['art']) . " LIMIT 1");
            ...
            )
            {
                ...
                if ($_POST['op'] == 'edit')
                {
                    ...
                    $loaded_record = gdrcd_query("SELECT * FROM regolamento WHERE articolo=" . gdrcd_filter('num',
                            $_POST['id_record']) . " LIMIT 1 ");
                ...
                <div class="panels_box">
                    <form action="main.php?page=gestione_regolamento"
                          method="post"
                          class="form_gestione">
                        ...
                        <div class='form_field'>
                            <input name="articolo"
                                   value="<?php echo 0 + $loaded_record['articolo']; ?>"/>

                        </div>

                        <div class='form_label'>
                            <?php echo gdrcd_filter('out',
                                $MESSAGE['interface']['administration']['rules']['title']); ?>
                        </div>
                        <div class='form_field'>
                            <input name="titolo"
                        ...
                        <div class='form_label'>
                            <?php echo gdrcd_filter('out',
                                $MESSAGE['interface']['administration']['rules']['infos']); ?>
                        </div>
                        <div class='form_field'>
            ...
            { /*Elenco record (Visualizzaione di base della pagina)*/
                ...
                //Lettura record
                $result = gdrcd_query("SELECT articolo, titolo, testo FROM regolamento ORDER BY articolo LIMIT " . $pagebegin . ", " . $pageend . "",
                    'result');
                            ...
                            <tr>
                                <td class="casella_titolo">
                                    <div class="titoli_elenco"><?php echo gdrcd_filter('out',
                                            $MESSAGE['interface']['administration']['rules']['art']); ?></div>
                                </td>
                                <td class="casella_titolo">
                                    <div class="titoli_elenco"><?php echo gdrcd_filter('out',
                                            $MESSAGE['interface']['administration']['rules']['titolo']); ?></div>
                                </td>
                                <td class="casella_titolo">
                                    <div class="titoli_elenco"><?php echo gdrcd_filter('out',
                                        ...
                                        <div class="controlli_elenco">
                                            <div class="controllo_elenco">
                                                <form class="opzioni_elenco_record_gestione"
                                                      action="main.php?page=gestione_regolamento" method="post">
                                                    <input type="hidden" name="id_record"
                                                           value="<?php echo $row['articolo'] ?>"/>
                ...
                <div class="link_back">
                    <a href="main.php?page=gestione_regolamento&op=new">
                        <?php echo gdrcd_filter('out',
                            $MESSAGE['interface']['administration']['rules']['link']['new']); ?>
                    </a>
                </div>
