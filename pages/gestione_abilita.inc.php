    ...
    { ?>
        ...
        <div class="page_body">
            ...
            if ($_POST['op'] == 'insert')
            {
                ...
                gdrcd_query("INSERT INTO abilita (nome, descrizione, car, id_razza) VALUES ('" . gdrcd_filter('in',
                        $_POST['nome']) . "', '" . gdrcd_filter('in',
                        $_POST['descrizione']) . "', " . gdrcd_filter('num', $_POST['car']) . ", " . gdrcd_filter('num',
                        $_POST['id_razza']) . ")");
                ?>
                <div class="warning">
                ...
                <div class="link_back">
                    <a href="main.php?page=gestione_abilita">
                        <?php echo gdrcd_filter('out',
                            $MESSAGE['interface']['administration']['skills']['link']['back']); ?>
                    </a>
                </div>
            <?php } ?>
            ...
            if (gdrcd_filter('get', $_POST['op']) == 'erase')
            {
                ...
                gdrcd_query("DELETE FROM abilita WHERE id_abilita=" . gdrcd_filter('num',
                        $_POST['id_record']) . " LIMIT 1");

                /*Aggiorno i personaggi*/
                gdrcd_query("DELETE FROM clgpersonaggioabilita WHERE id_abilita=" . gdrcd_filter('num',
                        $_POST['id_record']) . "");
                ?>
                <div class="warning">
            ...
            if (gdrcd_filter('get', $_POST['op']) == 'modify')
            {
                ...
                gdrcd_query("UPDATE abilita SET nome ='" . gdrcd_filter('in',
                        $_POST['nome']) . "', descrizione ='" . gdrcd_filter('in',
                        $_POST['descrizione']) . "', car = " . gdrcd_filter('num',
                        $_POST['car']) . ", id_razza = " . gdrcd_filter('num',
                        $_POST['id_razza']) . " WHERE id_abilita = " . gdrcd_filter('num',
                        $_POST['id_record']) . " LIMIT 1"); ?>
                <div class="warning">
            ...
            )
            {
                ...
                if (gdrcd_filter('get', $_POST['op']) == 'edit')
                {
                    ...
                    $loaded_record = gdrcd_query("SELECT * FROM abilita WHERE id_abilita=" . gdrcd_filter('num',
                            $_POST['id_record']) . " LIMIT 1 ");
                ...
                <div class="panels_box">
                    <form action="main.php?page=gestione_abilita"
                          method="post"
                          class="form_gestione">

                        <div class='form_label'>
                            <?php echo gdrcd_filter('out',
                                $MESSAGE['interface']['administration']['skills']['name']); ?>
                        </div>
                        ...
                        <div class='form_label'>
                            <?php echo gdrcd_filter('out',
                                $MESSAGE['interface']['administration']['skills']['infos']); ?>
                        </div>
                        <div class='form_field'>
                        ...
                        <div class='form_label'>
                            <?php echo gdrcd_filter('out',
                                $MESSAGE['interface']['administration']['skills']['race']); ?>
                        </div>
                        <div class='form_field'>
                            <select name='id_razza'>
                                <option value="-1" <?php if ($loaded_record['id_razza'] == -1)
                                {
                                    echo 'SELECTED';
                                } ?>>
                                    <?php echo gdrcd_filter('out',
                                        $MESSAGE['interface']['administration']['skills']['no_race']); ?>
                                </option>
                                <?php
                                $result = gdrcd_query("SELECT id_razza, nome_razza FROM razza ORDER BY nome_razza",
                                    'result');
                                while ($raz = gdrcd_query($result, 'fetch'))
                                {
                                    ?>
                                    <option
                                        value="<?php echo $raz['id_razza']; ?>" <?php if ($loaded_record['id_razza'] == $raz['id_razza'])
                                    {
                                        echo 'SELECTED';
                                    } ?> >
                        ...
                        <div class='form_submit'>
                            ...
                            if ($operation == "edit")
                            {
                                ...
                                <input type="hidden" name="id_record"
                                       value="<?php echo $loaded_record['id_abilita']; ?>">
                                <input type="hidden"
                                       name="op"
                                       value="modify"/>
                                <input type="submit"
                                       value="<?php echo gdrcd_filter('out',
                                           $MESSAGE['interface']['administration']['skills']['submit']['edit']); ?>"/>
                            <?php } /* Altrimenti il tasto inserisci */
                            else
                            { ?>
                                <input type="submit"
                                       value="<?php echo gdrcd_filter('out',
                                           $MESSAGE['interface']['administration']['skills']['submit']['insert']); ?>"/>
                                <input type="hidden"
                                       name="op"
                                       value="insert"/>
                            <?php } ?>
            ...
            <?php if (isset($_REQUEST['op']) === false)
            { /*Elenco record (Visualizzaione di base della pagina)*/
                ...
                /*
                $query="SELECT COUNT(*) FROM abilita";
                ...
                */
                ...
                //Lettura record
                $result = gdrcd_query("SELECT id_abilita, nome, car FROM abilita ORDER BY nome LIMIT " . $pagebegin . ", " . $pageend . "",
                    'result');
                    ...
                    <div class="elenco_record_gestione">
                        <table>
                            ...
                            <tr>
                                ...
                                <td class="casella_titolo">
                                    <div class="titoli_elenco"><?php echo gdrcd_filter('out',
                                            $MESSAGE['interface']['administration']['skills']['car']); ?></div>
                                </td>
                                <td class="casella_titolo">
                                    <div class="titoli_elenco"><?php echo gdrcd_filter('out',
                                        ...
                                        <div class="controlli_elenco">
                                            <div class="controllo_elenco">
                                                <form class="opzioni_elenco_record_gestione"
                                                      action="main.php?page=gestione_abilita" method="post">
                                                    <input type="hidden" name="id_record"
                                                           value="<?php echo $row['id_abilita'] ?>"/>
                ...
                <div class="link_back">
                    <a href="main.php?page=gestione_abilita&op=new">
                        <?php echo gdrcd_filter('out',
                            $MESSAGE['interface']['administration']['skills']['link']['new']); ?>
                    </a>
                </div>
