    ...
    <form action="main.php?page=gestione_abilita"
		  ...
		  <div class='form_submit'>  
			  ...
			  <input type="hidden"
					 ...
					 value="modify" />
			  <input type="submit" 
			         value="<?php echo gdrcd_filter('out',$MESSAGE['interface']['administration']['skills']['submit']['edit']);?>"/>
			  <?php	} /* Altrimenti il tasto inserisci */
					  else { ?>
			  <input type="submit" 
			         value="<?php echo gdrcd_filter('out',$MESSAGE['interface']['administration']['skills']['submit']['insert']);?>" />
			  <input type="hidden"
			         name="op"
					 value="insert" />
			  <?php	} ?>
	...
	if ($numresults>0){ ?>
       ...
       <table>
          ...
          <tr>
		     ...
		     <td class="casella_titolo"><div class="titoli_elenco"><?php echo gdrcd_filter('out',$MESSAGE['interface']['administration']['skills']['car']); ?></div></td>
