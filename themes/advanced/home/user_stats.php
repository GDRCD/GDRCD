...
?>					<strong><?php echo gdrcd_filter('out',$MESSAGE['interface']['user']['stats']['page_name']); ?></strong>
					...
					<table class="statistics">
						<tbody>
							<tr>
								<td class="label"><?php echo gdrcd_filter('out',$MESSAGE['interface']['user']['stats']['creation_date']); ?>:</td>
							...
							<tr class="pair">
								<td class="label"><?php echo gdrcd_filter('out',$MESSAGE['interface']['user']['stats']['last_characters']); ?>:</td>
