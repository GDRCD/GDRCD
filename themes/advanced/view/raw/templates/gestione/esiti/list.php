    ...
    <div class='tr <?= $row['closed_cls']; ?>'>
        ...
        <div class='td commands'>
            <?php if ($row['esito_view_permission']) { ?>
                <a href='/main.php?page=<?= $data['path']; ?>&op=read&id_record=<?= $row['id']; ?>'
                   title='Leggi'>
            ...
            <?php if ($row['esito_membri_permission']) { ?>
                <a href='/main.php?page=<?= $data['path']; ?>&op=members&id_record=<?= $row['id']; ?>'
            ...
            <?php if ($row['esito_manage'] && ($data['page'] == 'gestione')) { ?>
                <a href='/main.php?page=<?= $data['path']; ?>&op=master&id_record=<?= $row['id']; ?>'
