        ...
        <tr>
            <td class="home_left" rowspan="2">
                ...
                <div class="login_box">
                    <div class="panels_box">
                        <div class="form_gioco">
                            <form name="do_login" id="do_login" action="login.php"
                                  method="post"<?php if ($PARAMETERS['mode']['popup_choise'] == 'ON')
                            { ?>
                                  onsubmit="check_login(); return false;" <?php } ?>target="_top">
                                ...
                                <div class="form_submit"><input type="submit"
                                                                value="<?php echo $MESSAGE['homepage']['forms']['login']; ?>"/>
                                </div>
                            </form>
                        </div>
                    </div>
                    ...
                    <div class="panels_box">
                        <?php if ($_POST['newp'] == "changepass")
                        {
                            ...
                            if (gdrcd_query($newpass, 'num_rows') > 0)
                            {
                                ...
                                $subjcet = gdrcd_filter('out',
                                    $MESSAGE['register']['forms']['mail']['sub'] . ' ' . $PARAMETERS['info']['site_name']);
                                $text = gdrcd_filter('out',
                                    $MESSAGE['register']['forms']['mail']['text'] . ': ' . $pass);

                                mail($_POST['email'], $subject, $text,
                                    'From: ' . $PARAMETERS['info']['webmaster_email']);
                ...
                <div class="main_links">
                    ...
                    <a href="index.php?page=ambientazione&content=user_ambientazione">
                        <div class="page_title"><h2>
                                <?php echo $MESSAGE['homepage']['storyline']; ?>
                            </h2></div>
                    </a>
                    <a href="index.php?page=ambientazione&content=user_regolamento">
                        <div class="page_title"><h2>
            ...
            <td class="home_right">
                ...
                <div class="online_box">
                    ...
                    <div class="page_title"><h2>
                            <?php echo $row['counter'] . ' ' . gdrcd_filter('out',
                                    $MESSAGE['homepage']['forms']['online_now']); ?>
                        </h2></div>
                </div>
        ...
        <tr>
            <td class="home_bottom" colspan="3">
                <div class="homepage_info_box">
                    ...
                    <?php echo gdrcd_filter('out', $PARAMETERS['info']['site_name']) . ' - ' . gdrcd_filter('out',
                            $MESSAGE['homepage']['info']['webm']) . ': ' . gdrcd_filter('out',
                            $PARAMETERS['info']['webmaster_name']) . ' - ' . gdrcd_filter('out',
                            $MESSAGE['homepage']['info']['email']) . ': <a href="mailto:' . gdrcd_filter('out',
                            $PARAMETERS['info']['webmaster_email']) . '">' . gdrcd_filter('out',
                            $PARAMETERS['info']['webmaster_email']) . '</a>. <br />' . $CREDITS . ' ' . $LICENCE; ?>
                </div>
